//
//  SlideTransitionPresentationController.swift
//  SlideTransition
//
...
@available(iOS 10.0, *)
public class SlideTransitionPresentationController: UIPresentationController {
    ...
    weak var cardAnimator: SlideTransitionAnimator!
    ...
    public private(set) var configuration: SlideTransitionConfigurator
    
    public override init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?) {
        fatalError("Use init(configuration:presentedViewController:presenting:)")
    }
    
    public init(configuration: SlideTransitionConfigurator, presentedViewController: UIViewController, presenting presentingViewController: UIViewController?) {
    ...
    public override func dismissalTransitionDidEnd(_ completed: Bool) {
        ...
        sourceController?.removeTransitionManager()
    }
...
extension SlideTransitionPresentationController: UIGestureRecognizerDelegate {
