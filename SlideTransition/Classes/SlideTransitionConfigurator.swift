//
//  SlideTransitionConfigurator.swift
//  SlideTransition
//
...
public struct SlideTransitionConfigurator {
    ...
    public static var shared = SlideTransitionConfigurator()
    
}

extension SlideTransitionConfigurator {
